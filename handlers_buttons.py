...
from config import (AWAITING_FAHRER_NAME, AWAITING_LKW_KENNZEICHEN, AWAITING_PKW_KENNZEICHEN,
                   AWAITING_SCHADEN_FAHRZEUG, AWAITING_SUPERVISOR_NACHRICHT, 
                   AWAITING_TOUR_START_KM, AWAITING_TOUR_ENDE_KM)
